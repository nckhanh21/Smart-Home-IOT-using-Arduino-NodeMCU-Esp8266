...
unsigned long thoiGianBatDau = 22 * 3600L + 59 * 60 + 55;
int hour = 0;
int minute = 0;
int second = 0;
    ...
    case (2): // dieu hoa
      {
        ...
        if (scanMatrix() == '6') {
          caiDatDieuHoa = tang(caiDatDieuHoa, 1);
          if (caiDatDieuHoa > 40) {
            caiDatDieuHoa = 0;
            lcd.clear();
          }
    ...
    case (3):  // rem cua
      {
        ...
        hienThiCaiDatRemCua();
        if (scanMatrix() == '6') {
          caiDatRemCua = tang(caiDatRemCua, 50);
          if (caiDatRemCua > 1000) {
            caiDatRemCua = 0;
            lcd.clear();
          }
        }
    ...
    case (4):  // nong lanh
      {
        ...
        if (scanMatrix() == '6') {
          caiDatNongLanh = tang(caiDatNongLanh, 1);
          if (caiDatNongLanh > 23) {
            caiDatNongLanh = 0;
            lcd.clear();
          }
        }
